...
type BuildMeta interface {
	ValidatePatch(other BuildMeta) (*ValidateBuildMetaPatchResponse, error)
}
...
func (bm *EmptyBuildMeta) ValidatePatch(other BuildMeta) (*ValidateBuildMetaPatchResponse, error) {
	return &ValidateBuildMetaPatchResponse{DidChange: false}, nil
}
...
func (bm *DockerBuildMeta) ValidatePatch(other BuildMeta) (*ValidateBuildMetaPatchResponse, error) {
	b2, ok := other.(*DockerBuildMeta)
	if !ok {
		return nil, fmt.Errorf("invalid build meta type")
	}
...
func (bm *DockerRegistryMeta) ValidatePatch(other BuildMeta) (*ValidateBuildMetaPatchResponse, error) {
